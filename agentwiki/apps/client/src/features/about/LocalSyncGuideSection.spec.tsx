...
describe('LocalSyncGuideSection', () => {
  it('shows the verified Chinese workflow and safe defaults', () => {
    ...
    expect(screen.getByText('版本 0.10.0')).toBeInTheDocument();
    expect(LOCAL_SYNC_PACKAGE_URL).toBe('https://www.npmjs.com/package/@neomei/agentwiki-local-sync/v/0.10.0');
