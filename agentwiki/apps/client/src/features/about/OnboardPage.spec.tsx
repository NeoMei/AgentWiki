...
const COMMAND = 'npx --yes @neomei/agentwiki-local-sync@0.3.1 onboard --server https://agentwiki.quukk.com/api --protocol ndjson';
...
describe('OnboardPage 0.3 onboarding guide', () => {
  ...
  it('shows one pinned command and the three human actions in Chinese', () => {
    ...
    expect(container.textContent?.match(/@neomei\/agentwiki-local-sync@0\.3\.1/g)).toHaveLength(1);
