...
const copy = {
  'zh-CN': {
    ...
    syntax: '支持 CommonMark 与 GFM 标题、强调、链接、列表、引用、删除线、表格、任务清单、围栏代码与代码高亮，以及 Wiki 链接、别名、标题链接、块链接、==高亮== 和 Callout。',
    checklist: '清单模式：编辑器预览中勾选只更新未保存草稿，保存页面后持久化；已发布页面中，所有者、管理员和编辑者勾选会立即保存并生成新版本；查看者与历史版本预览只读。',
    forbidden: [/实时预览/u, /所见即所得/u, /数学公式/u, /Mermaid/u, /图片附件/u],
  },
  en: {
    title: 'Markdown editing and shared preview',
    syntax: 'Supports CommonMark and GFM headings, emphasis, links, lists, blockquotes, strikethrough, tables, task lists, fenced code and syntax highlighting, plus wiki links, aliases, heading links, block links, ==highlights==, and Callouts.',
    ...
    forbidden: [/live WYSIWYG preview/iu, /math formulas/iu, /Mermaid/u, /image attachments/iu],
  },
} as const;
