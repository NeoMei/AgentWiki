...
import { BookOpen, Home, LayoutDashboard, Rocket, FileText } from 'lucide-react';
...
export const GlobalNavigation: React.FC<GlobalNavigationProps> = ({ density = 'public' }) => {
  ...
  const items = [
    ...
    { label: t('nav.manual'), to: '/manual', active: pathname === '/manual', icon: FileText },
    { label: t('nav.guide'), to: '/guide', active: pathname === '/guide', icon: BookOpen },
    { label: t('nav.onboard'), to: '/onboard', active: pathname === '/onboard', icon: Rocket },
    {
