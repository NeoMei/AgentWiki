...
export const LEGACY_UNIFIED_RECIPE_VERSION = 'unified-knowledge@1';
...
export function isLegacyUnifiedRevisionFormat(revision: SyncRevisionFormat): boolean {
  return revision.schemaVersion === SYNC_V1_SCHEMA_VERSION
    && revision.recipeVersion === LEGACY_UNIFIED_RECIPE_VERSION;
}
...
export function isSupportedLegacySyncRevisionFormat(revision: SyncRevisionFormat): boolean {
  return isSyncV1RevisionFormat(revision)
