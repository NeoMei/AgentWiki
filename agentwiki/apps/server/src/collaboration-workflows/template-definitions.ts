...
const bidWritingTemplate = defineSeed({
  ...
  definition: {
    ...
    dependencies: [
      edge('tender-analysis', 'bid-consensus-review'), edge('material-catalog', 'bid-consensus-review'),
      ...
      edge('write-technical-sections', 'missing-material-review'), edge('write-service-sections', 'missing-material-review'),
      edge('missing-material-review', 'coverage-and-visual-check'),
