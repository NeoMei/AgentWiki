...
> 当前源码版本：**v0.2.9**（npm 0.2.9 已暂存，待 WebAuthn 批准）
...
> 注：公网 `latest` 在 0.2.9 完成 npm WebAuthn 批准前仍为 0.2.5。
...
- [设计文档](./design/)
- [AGENTS.md](./AGENTS.md)
- [v0.2.9 上线验证报告](./agentwiki/docs/verification/production-readiness-0.2.9.md)
