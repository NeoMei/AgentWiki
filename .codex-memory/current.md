...
- 运行修复74f885ed、主分支整合验证8d48b47c；版本发布对象v0.10.2，后续仅验收归档。修复编辑器迟到GET/光标、搜索索引/向量一致性、目录实时鉴权与原超时；运行和开发依赖通告清零。
...
- 本地路径末尾空格；Git必须显式--work-tree。保留原验收空间和本地预览工作树，不动他人会话及子模块。
