...
- Agent 客户端 MCP 配置：`agentwiki/packages/local-sync/src/agent-clients.ts`
- 本地 MCP：`agentwiki/packages/local-sync/src/mcp.ts`
- 本地 Orchestrator：`agentwiki/packages/local-sync/src/core/orchestrator.ts`
- 稳定架构规则：`.codex-memory/spec/agentwiki-architecture.md`
- 本地知识规则：`.codex-memory/spec/local-knowledge-sync.md`
- 已发布包：https://www.npmjs.com/package/@neomei/agentwiki-local-sync
- 生产服务：https://agentwiki.quukk.com
