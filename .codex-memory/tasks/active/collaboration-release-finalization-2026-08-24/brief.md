...
- 完成 Sync Protocol `0.3.0`、Local Sync `0.6.0`、GitHub 与生产部署发布链，并核对四个发布面。

## 当前状态

- 本地 `master` 与 GitHub `origin/master` 已对齐到 `ca03eb220a8db66f1a716f281ab43fc98bbff5c5`。
- npm 仍为 Sync Protocol `0.2.0`、Local Sync `0.5.1`；生产仍公告 Local Sync `0.5.1`。
...
- 下一阶段为提交/推送本轮修复，然后发布 npm 与部署生产；发布完成前不得归档。
